...
<head>
  ...
  <title>Manage Welcome Data</title>
  <link href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
<?php include '../includes/admin.php'; ?>
<div class="container">
  <h2>Manage Welcome Data</h2>
    <a href="add_welcome.php">Add New</a>
    ...
    <tbody>
      <?php
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["delete_id"])) {
            ...
            $sql_delete = "DELETE FROM welcome WHERE id = '$delete_id'";
        ...
        if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
                ...
                echo "<td><a href='update_welcome.php?id=".$row["id"]."' class='btn btn-primary'>Update</a></td>";
                echo "</tr>";
            }
        } else {
  ...
  <script>
    ...
    function updateData(id) {
      ...
      window.location.href = "update_welcome.php?id=" + id;
    }
  </script>
</body>
</html>
