    ...
    <title>Manage Navbar Data</title>
    <link href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css" rel="stylesheet">
    </head>
    <body>
    <?php include '../includes/admin.php'; ?>
    <div class="container">
    <h2>Manage Navbar Data</h2>
        <a href="add_navbar.php">Add New</a>
    ...
    <table class="table">
        ...
        <?php
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["delete_id"])) {
                ...
                $sql_delete = "DELETE FROM navbar WHERE id = '$delete_id'";
            ...
            if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    echo "<td><img src='../admin/uploads/" . $row["Logo"] . "' alt='Logo' style='max-width: 100px;'></td>";
                    echo '<td><button class="btn btn-danger" onclick="deleteData(' . $row["id"] . ')">Delete</button></td>';
                    echo "<td><a href='update_navbar.php?id=".$row["id"]."' class='btn btn-primary'>Update</a></td>";
                    echo "</tr>";
                }
            } else {
