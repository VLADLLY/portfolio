...
<head>
  ...
  <title>Manage Blog Data</title>
  <link href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
<?php include '../includes/admin.php'; ?>
<div class="container">
  <h2>Manage Skill Data</h2>
    <a href="add_skill.php">Add New</a>
      ...
      <?php
        ...
        if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
                ...
                echo "<td><img src='../admin/uploads/" . $row["skill_image"] . "' alt='Skill Image' style='max-width: 100px;'></td>";
                echo "<td>" . $row["description"] . "</td>";
                echo '<td><button class="btn btn-danger" onclick="deleteData(' . $row["id"] . ')">Delete</button></td>';
                echo "<td><a href='update_skill.php?id=".$row["id"]."' class='btn btn-primary'>Update</a></td>";
                echo "</tr>";
            }
        } else {
